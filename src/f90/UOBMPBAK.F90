      ...
      program uobmpbak 
!     final MPQS program for  80 digit numbers AVOIDING DIVISION    
!     smaller sieving interval  and up to 30000 prime base
...
!     also large prime variant extension      
      ...
      common ibbp(10000),nbbp(10000)
      dimension kr(62000,2),mm(20),mres(20),n(50),msqr(20)
      dimension mmsq(20),mstem(20),zlog(10000)
      dimension iaeq(50),ibeq(50),iceq(50),ninv(50),ixx(5)
      dimension ibbeq(50),kkm(62000,2)
...
!      stop
      ...
      open(unit=4,file='snx',access='sequential')
...
!     changes for large prime variant     
      ...
      write(3,5,rec=2)(kr(jf,1),jf=1,62000)
      write(3,5,rec=3)(kr(jf,2),jf=1,62000)
...
!     start of big loop      
      ...
      read(3,5,rec=2)(kr(jf,1),jf=1,62000)
      read(3,5,rec=3)(kr(jf,2),jf=1,62000)
...
!     instruction changes for small prime variant  limit incr. by 4    
      if (krecarr(kz).gt.91.0)goto 690
!     compute accurately      
...
1300  irecnn=irecnn+1
      ...
      ,'iconq',iconq ,'iccz',iccz,'imatc',imatc
