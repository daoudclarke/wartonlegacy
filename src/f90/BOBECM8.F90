...
!     in 2 dimensions increased dimensions     
      ...
      dimension ixl(30,50),iyl(30,50)
      integer,allocatable,dimension (:,:,:)::ixdf,iydf
! set for continuation of 36 digit no.
      iaa=241
      iarrsz=5000
      iarrsz2=2*iarrsz
      iarrlb=iarrsz/5
...
20018 if ((ipr(iprc+1).eq.799999).and.(ipr(iprc+1)-ipr(iprc).gt.iarrsz2))&
      goto 20019
...
!      print *,'ipcon',ipcon,'iccon',iccon
      if (ipr(iprc+i).eq.799999)goto 2200
...
809   do i=1,30
      ...
      iprc=iprc+1
      goto 808
82003 read(2,4992,rec=irecnn)(ipr(jf),jf=1,65000)      
      iprc=1
      goto 808
820   do i=1,30
      do jf=1,ixp(i,2)+2
