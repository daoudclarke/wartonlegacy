      ...
      dimension kpr1(8000),kpr2(8000),mpr1(8000),mpr2(8000)
      dimension npr1(8000),npr2(8000),nar(8000,20),nar2(8000,20)
      dimension littr(20),normar(20),iabp(50),iabpn(50),ity(50)
      dimension izzy(500),nh(60),narr(50),nbarr(50),ipd(50)
      ...
      irecnn=0
      ipoin=0
      open(unit=2,file='gpx3',access='sequential')
      open(unit=3,file='gpx2',access='direct',form=&
...
60    read(4, *)irecnn,kkb,ihitn,icur,(littr(j1),j1=1,20)
      
      read(4, *)irecnn,(iabp(i),iabpn(i),ity(i),i=1,icur)
      print *,'irecnn',irecnn
      iconz=iconz+1
      if (iconz.ne.4)goto 60
      rewind(unit=4)
      
      print *,'littr',(littr(jf),jf=1,littr(2)+2),'irecnn',irecnn,&
      'ihitn',ihitn
      do i=1,icur
...
61    a=a       
      ...
      read (7,1006,rec=1)(nh(jf),jf=1,60)
1006  format (60i4)      
      do jf=1,nh(2)+2
      karr(jf)=nh(jf)
      end do
...
33    write(2, *)irecnn,kkb,ihitn,kmx1,kmx2,isgn      
      write(2, *)irecnn,(kpr1(j1),j1=1,kmx1),&
      (iabpn(jf),jf=1,kmx1+kmx2)
      print *,'firkpr1',(kpr1(i),i=1,kmx1)
      print *,'firkpr2',(kpr2(i),i=1,kmx2)
      ksum1=kmx1
      ksum2=kmx2
...
132   end do
      ...
      isgn=1
133   write(2, *)irecnn,kkb,ihitn,mmx1,mmx2,isgn
      write(2, *)irecnn,(mpr1(j1),j1=1,mmx1),(mpr2(j2),j2=1,mmx2),& 
      (iabpn(jf),jf=1,mmx1+mmx2)
      print *,'mpr1',(mpr1(i),i=1,mmx1)
      print *,'mpr2',(mpr2(i),i=1,mmx2)
...
50    a=a
      ...
      ind2=1
      ind3=1
254   if (kpr2(ind1).lt.mpr2(ind2))goto 300
      
      
      if (kpr2(ind1).gt.mpr2(ind2))goto 302
      npr2(ind3)=kpr2(ind1)
...
400   close(unit=4) 
      ...
      print *,'kpr2',(kpr2(j),j=1,kmx2)
      print *,'kmx1=',kmx1,'kmx2=',kmx2
      print *,'ksum1=',ksum1,'ksum2=',ksum2
      print *,'irecnn',irecnn
      
      read(3,72222,rec=1)irecnn,iconq,(narr(jf),jf=1,50),&
      (nbarr(jk),jk=1,50)
! this instruction is only temporary      
!      ipd(2)=4
      kkll=kmx1+kmx2+iconq
      kkll2=kkll*4*(ipd(2)+2)+91
      print *,'kkll',kkll,'kkll2',kkll2
      kkll3=25+kkll*5
      open (unit=4,file='dsiev',access='direct',form=&
      'formatted',recl=kkll3,status='old')
      write (4,1004,rec=1)izzy(1),kmx1,kmx2,izzy(3),izzy(4),&
      (kpr1(jf),jf=1,kmx1),(kpr2(jf),jf=1,kmx2),(izzy(jk),jk=1,iconq)
1004  format (5i5,3000i5)
      close (unit=4)
      
!      open (unit=1,file='bexp1',access='direct',form=&
!      'formatted',recl=kkll2,status='old')
! file below is only temporary      
...
!     first record has no type 2's      
      read(2, *,end=500)irecnn,kkb,ihitn,mmx1,mmx2,isgn
...
52    end do
54    end do
      write(1,499,rec=irecnn)kkb,ihitn,izzy(1),isgn,isgn,(izzy(jf),jf=4,&
      20),((nar(i,jf),jf=1,ipd(2)+2),&
      i=1,kmx1),((nar2(j,jf),jf=1,ipd(2)+2),j=1,kmx2+iconq)
      print *,'irecnn',irecnn
401   do i=1,kmx1
      do jf=1,20
      nar(i,jf)=0
      ...
      read(2, *)irecnn,(mpr1(j1),j1=1,mmx1),(mpr2(j2),j2=1,mmx2),&
      (iabpn(jf),jf=1,mmx1+mmx2)
      jnd=1
      do i=1,mmx1
      do j=jnd,kmx1
...
404   end do
      ...
      do i=1,mmx2
      do j=jnd,kmx2
      if (mpr2(i).gt.kpr2(j))goto 412
      
      nar2(j,1)=0
      nar2(j,2)=1
      nar2(j,3)=iabpn(i+mmx1)
      jnd=j+1
      goto 414
412   end do
414   end do
      ...
      i=1,kmx1),((nar2(j,jf),jf=1,ipd(2)+2),j=1,kmx2+iconq)
      print *,'irecnn',irecnn
499   format(i1,i10,20i4,5000(20i4),5000(20i4))
      goto 401
500   a=a
      irecnn=1
      norec=2
      ...
      narc=kmx2+1
502   ibeg=irecnn+1
      read(3,72222,rec=norec)irecnn,ispac,(narr(jf),jf=1,50),&
      (nbarr(jk),jk=1,50)
      iend=irecnn
      do jj=ibeg,iend
      read(1,499,rec=jj)kkb,ihitn,izzy(1),isgn,isgn,(izzy(jf),jf=4,&
      20),((nar(i,jf),jf=1,ipd(2)+2),&
      i=1,kmx1),((nar2(j,jf),jf=1,ipd(2)+2),j=1,kmx2+iconq)
      ...
      write(1,499,rec=jj)kkb,ihitn,izzy(1),isgn,isgn,(izzy(jf),jf=4,&
      20),((nar(i,jf),jf=1,ipd(2)+2),&
      i=1,kmx1),((nar2(j,jf),jf=1,ipd(2)+2),j=1,kmx2+iconq)
      print *,'second pass irecnn=',jj
      end do
      
      
      if (norec.eq.iconq)goto 600
      norec=norec+1
      narc=narc+1
      goto 502
600   close (unit=3)
      open (unit=6,file='exppar',access='direct',form=&
      'formatted',recl=344,status='old')
      read (6,1002,rec=1)ixxy,ixxz,ijpow,nfak,(ibase(jf),jf=1,20),&
      (jbase(jf),jf=1,20),(itarg(jf),jf=1,20),(jtarg(jf),jf=1,20)
1002  format (i6,i6,i8,i4,20i4,20i4,20i4,20i4)
      write (6,1002,rec=1)irecnn,kkll,ijpow,nfak,(ibase(jf),jf=1,20),&
      (jbase(jf),jf=1,20),(itarg(jf),jf=1,20),(jtarg(jf),jf=1,20)
