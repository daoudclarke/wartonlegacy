      ...
      program ann2
!     second generalized MPQS program
!     compactification routine for MPQS for 66 digit nos      
      ...
      irecnn=0
      ipoin=0
      open(unit=2,file='annf3',access='sequential')
      
      
      open(unit=4,file='annf1',access='sequential')
      n=1
...
499   format(i1,i10,20i4,40000i1)
      goto 401
...
502   ibeg=irecnn+1
      ...
      iend=irecnn
      do jj=ibeg,iend
      read (1,499,rec=jj)kkb,ihitn,(littr(jf),jf=1,20),(nar(i),i=1,kkll)
      nar(narc)=1
      write (1,499,rec=jj)kkb,ihitn,(littr(jf),jf=1,20),(nar(i),i=1,kkll)
      end do
...
72222 format(i6,i4,50i4,50i4)
      print *,'narc=',narc,'iconq=',iconq
      open(unit=6,file='annpar',access='direct',form=&
      'formatted',recl=24,status='replace')
      nzz=0
      write(6,72223,rec=1)irecnn,kkll,nzz

72223 format(i8,i8,i8)      
      close(unit=6)
      close(unit=1)
      end
