      ...
      idrv1(3)=105
      idrv1(4)=282
!     attention parameter change here      
      mm=200
      read(1,1,rec=5)(iv(ii),ii=1,mm)
1     format(200i5)
2     format(400i5)
      do i=1,mm
      if (iv(i).ne.0)goto 3
...
3     read(2,2,rec=1)(match(ii),ii=1,mm*2)
      ...
      print *,'match4',(match(jf),jf=1,mm*2)
...
!     temporary treatment of non-homogeneous polynomials      
      do jf=1,5
      kdoub1(jf,1)=0
      kdoub1(jf,2)=1
      end do
...
555   end do
      ...
      print *,(kdoub1(ii,jf),jf=1,kdoub1(ii,2)+2)
      end do
