...
!     stop
      ...
      open(unit=7,file='anncode',access='direct',form=&
...
594   end do      
      ...
      print *,'end y stage'
      open(unit=2,file='annf2',access='direct',form=&
      'formatted',recl=410,status='old')
      print *,'okk'
      do jf=3,iaeq(2)+2
      mnum(jf-2)=iaeq(jf)
...
9777  do jf=1,kcarr(2)+2
      ...
      kia=kz
      call sieve(kia,kkb,irecnn,kkmx,icdn,iconq,limprm2)
...
730   print *,'run completed',' no of records=',irecnn
      ...
      subroutine sieve(kia,kkb,irecnn,kkmx,icdn,iconq,limprm2)
      common karr(50),kbarr(50),kcarr(200),ipqt(50),irrr(50)
      common mnum(50)
      common ia5(5),ia4(5),ia3(5),ia2(5),ia1(5),ia0(5),m1(5),m2(5)
      common ipr(65000),norma(50),gpr(40000)
