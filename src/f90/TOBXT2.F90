       program tobxt2
!      computation of kernel of matrix quad sieve 68 digit nos.        
!      for use by quadratic sieve program and MPQS       
       
       
       dimension indic(9000),iqi(101,9000),iqi2(101,9000),iv(9000)
       ...
       'formatted',recl=9000,status='new')
       read (1,1,rec=20)kkb,ihitn,(littr(jf),jf=1,20),(nar(jk),jk=1,8900)
       ...
       do i=8874,9000
       write (1,1,rec=i)kkb,ihitn,(littr(jf),jf=1,20),(nar(jk),jk=1,8900)
       end do
