...
!     idis has positive value of negative discriminant      
      ...
      common mult1(7,2,1200),mult2(7,2,1200),mult3(7,2,1200)
...
20    iia=iia+1
      ...
      mult1(i,ibig,2)=mult1(i,ibig,2)-600
...
!     program for computing modular invariants ex "bobtrial"
      ...
      dimension iiq(2,1240),idel(2,2,5000),itab(1200),iffy(2,1240)
      ...
      do jf=iptop(k,2)+1,iptop(k,2)+600
      karr(jf)=0
      end do
...
!      if (icont.le.200)goto 1000
      if (icont.le.600)goto 621
      goto 622
621   kbarr(1)=0
      kbarr(2)=0
      goto 623
622   do jf=1,icont-600
      kbarr(jf+2)=ipqt(jf)
      end do
      kbarr(1)=0
      kbarr(2)=icont-600
...
!      print *,'ifack2',ifack(2),'i',i,'itop22',itop2(2)
      ...
      inabc=101
!      if (icont.le.200)goto 1000
      if (icont.le.600)goto 611
      goto 612
611   kbarr(1)=0
      kbarr(2)=0
      goto 613
612   do jf=1,icont-600
      kbarr(jf+2)=ipqt(jf)
      end do
...
!      end do
      ...
      inabc=102
!      if (icont.le.200)goto 1000
      if (icont.le.600)goto 631
      goto 632
631   kbarr(1)=0      
      kbarr(2)=0
      goto 633
632   do jf=1,icont-600
      kbarr(jf+2)=ipqt(jf)
      end do
      kbarr(1)=mod(i,2)
      kbarr(2)=icont-600
