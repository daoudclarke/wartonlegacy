...
! z form of bobst
      ...
      dimension kpr1(2000),kpr2(8000),mpr1(2000),mpr2(8000)
      dimension npr1(2000),npr2(8000),nar(2000),nar2(8000)
      dimension littr(20),normar(20),iabp(50),iabpn(50),ity(50)
      dimension izzy(100),kabpn(2000),kabpn2(2000),mabpn(2000),mabpn2(2000)
      do i=1,100
      izzy(i)=0
      end do
      ...
      irecnn=0
      ipoin=0
      open(unit=2,file='zfile1',access='sequential')
      
      
      open(unit=4,file='hits',access='sequential')
      n=1
...
33    write(2, *)irecnn,kia,kib,kmx1,kmx2,isgn      
      ...
      (kabpn(jf),jf=1,kmx1),(kabpn2(jf),jf=1,kmx2)
...
133   write(2, *)irecnn,kia,kib,mmx1,mmx2,isgn
      ...
      (mabpn(jf),jf=1,mmx1),(mabpn2(jf),jf=1,mmx2)
...
414   end do
      ...
      (nar2(j),j=1,kmx2),(izzy(jl),jl=1,10)
