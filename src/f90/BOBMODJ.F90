...
20    iia=iia+1
      ...
      mult1(i,ibig,2)=mult1(i,ibig,2)-200
...
15    return
      ...
      common mult1(5,2,400),mult2(5,2,400),mult3(5,2,400)
      common marr(2000),mbarr(2000),mcarr(2000),mdarr(2000)
      dimension icomp1(400),icomp2(400)
...
!     program for computing modular invariants ex "bobtrial"
      ...
      dimension itop1(520),itop2(520),ifack(420),iesum(420)
      dimension iiq(2,420),idel(2,2,1000),itab(400),iffy(2,420)
      dimension ieesum(2,400),itemsy(420),ifsum(420)
