      ...
      program bobpoly
!     program for creating polynomials for bobecm & bobecm2 
      ...
      common iarq(2)
      common kmpol(6,20)
      common kdoub1(2,4),kdoub2(201,500),kdoub3(201,500)
      dimension ipow(201,140)
      open(unit=1,file='polypow',access='direct',form=&
      'formatted',recl=560,status='old')
      open(unit=2,file='polynom',access='direct',form=&
      ...
      kdoub2(2,2)=1
      kdoub2(2,3)=500
      write(1,1111,rec=1)(kdoub2(1,jf),jf=1,140)
      write(1,1111,rec=2)(kdoub2(2,jf),jf=1,140)
1111  format(140i4)      
...
1     call doubmul2(idegm,idegn)
      ...
      irecp=irecp+1
      print *,'irecp',irecp,'idegn',idegn
      write(1,1111,rec=irecp)(kdoub2(i,jf),jf=1,140)
      
      
      end do
      icz=icz+1
      if (icz.lt.199)goto 1
      print *,'lengths',(kdoub3(jf,2),jf=1,201)
...
10    do jf=1,kdoub1(2,2)+2
      ...
      if (kdoub1(2,2).eq.1)goto 7
      if (mod(kdoub1(2,4),5).eq.0)goto 10
      goto 8
7     if (mod(kdoub1(2,3),5).eq.0)goto 10
8     end do
      do i=1,201
      write(2,2222,rec=i)(kdoub2(i,jf),jf=1,300)
      print *,'kdoub',(kdoub2(i,jf),jf=1,kdoub2(i,2)+2)
      end do
      nrec=202
...
!     start big loop 'ibig'      
      ...
      irv=irs
      i22=201-i2
      if (kdoub2(i22,2).eq.0)goto 113
      
      
      
      do i3=1,i2+1
      
      read(1,1111,rec=irv)(ipow(i3,jf),jf=1,140)
      irv=irv+1
      
      do jf=3,kdoub2(i22,2)+2
      karr(jf-2)=kdoub2(i22,jf)
      end do
      ilen=kdoub2(i22,2)
      
      do jf=3,ipow(i3,2)+2
      kbarr(jf-2)=ipow(i3,jf)
      end do
      ilen2=ipow(i3,2)
...
!      print *,'ilen3',ilen3
      ...
      i23=200-i2+i3
      do jf=1,kdoub3(i23,2)+2
      kbarr(jf)=kdoub3(i23,jf)
      end do
      call mpadd(0)
      do jf=1,kcarr(2)+2
      kdoub3(i23,jf)=kcarr(jf)
      end do
      end do
113   end do
      do i=ibig,201
      ...
      do i=ibig,201
      write(2,2222,rec=nrec)(kdoub3(i,jf),jf=1,300)
      print *,'i',i,'length',kdoub3(i,2),'ibig',ibig
      if (kdoub3(i,2).gt.297)goto 99
!      print *,'poly',(kdoub3(i,jf),jf=1,kdoub3(i,2)+2)
      nrec=nrec+1
      end do
      do i=1,201
      do j=1,500
...
99    print *,'disk area too small'
      ...
      do i=1,idegn+1
!      print *,'i2',i2
      print *,'kdoub3',i,(kdoub3(i,j),j=1,kdoub3(i,2)+2)
      end do
      loct=7+i2*500
      if (loct.lt.10000)goto 11 
      kdoub1(2,2)=2
      kdoub1(2,3)=loct/10000
      kdoub1(2,4)=loct-kdoub1(2,3)*10000
      goto 12
11    kdoub1(2,2)=1
      kdoub1(2,3)=loct
      
12    loct2=1000*i2+4
      if (loct2.lt.10000)goto 21
      kdoub2(2,2)=2
      kdoub2(2,3)=loct2/10000
      kdoub2(2,4)=loct2-kdoub2(2,3)*10000
      goto 22
21    kdoub2(2,2)=1
      kdoub2(2,3)=loct2
...
22    loct3=(500*i2+1)*(500*i2+3)
      if (loct3.lt.100000000)goto 31
      kdoub2(3,2)=3
      kdoub2(3,3)=loct3/100000000
      ktem=loct3-kdoub2(3,3)*100000000
      kdoub2(3,4)=ktem/10000
      kdoub2(3,5)=ktem-kdoub2(3,4)*10000
      goto 32
31    if (loct3.lt.10000)goto 41
      kdoub2(3,2)=2
      kdoub2(3,3)=loct3/10000
      kdoub2(3,4)=loct3-kdoub2(3,3)*10000
      goto 32
41    kdoub2(3,2)=1
      kdoub2(3,3)=loct3
...
513   print *,'k',k
      ...
      subroutine doubmul2(idegm,idegn)
      common karr(500),kbarr(500),kcarr(2000),ipqt(500),irrr(500)
      common mnum(50)
      common ia5(5),ia4(5),ia3(5),ia2(5),ia1(5),ia0(5),m1(5),m2(5)
      common kara(50),karb(50),kard(50),karp(50),karv(50)
