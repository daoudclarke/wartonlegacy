...
!     this program incrementally extends factor by examining
!     hit rate every 2 polynomials until a satisfactory rate is achieved      
!     also large prime variant extension      
      ...
      dimension kr(60000,2),mm(20),mres(20),n(60),msqr(20)
      ...
      dimension itab(100),jtab(100),numb1(60),ipre(60),icurr(60)
...
!     input of code and square root and parameter determination
      ...
      llg=int(vlg)
      indy=(n(2)-1)*4+llg-50
      if (indy.lt.0)goto 58
      itypp=0
      if (n(2).le.16)goto 59
      itypp=1
      goto 59
58    print *,'number too small:retry using daoud suite'
      stop



59    mimprm=106-(indy*5)/7
      mimprm2=mimprm+4
      lvim=105+indy*15
      if (indy.gt.10)goto 2
      limprm=2000+(indy*600)/5
      lenb2=(limprm*3)/2
      goto 3
2     limprm=3000+(indy-9)*450
      lenb2=limprm

3     print *,'limprm',limprm,'mimprm',mimprm,'lenb2',lenb2,'indy',indy
      print *,'lvim',lvim
...
40    do jf=3,numb1(2)+2      
      ...
      if (icurr(2).gt.ipre(2))goto 50
      do jf=3,ipre(2)+2
      if (icurr(jf).lt.ipre(jf))goto 45
      if (icurr(jf).gt.ipre(jf))goto 50
      end do
      goto 50
...
50    print *,'int. root',(icurr(jf),jf=1,icurr(2)+2)
      icurr(2)=icurr(2)-2
      inz=icurr(2)+2
      inz2=mod(icurr(inz),2)
      if (inz2.eq.1)goto 52
      do jf=1,icurr(2)+2
      karr(jf)=icurr(jf)
      end do
      kbarr(1)=0
      ...
      goto 54
52    do jf=1,icurr(2)+2
      iaeq(jf)=icurr(jf)
      end do
54    print *,'iaeq',(iaeq(jf),jf=1,iaeq(2)+2)
...
400   do i=1,60000
      ...
      goto 4004
4002  print *,'factor found early=2','iva=',iva,'niva',n(iva),'n2',n(2)
      stop
...
!     change parameter      
      limprm2=limprm3
      print *,'limprm2',limprm2,'iprlm',ipr(limprm2)
...
594   end do      
      ...
      write(7,6111,rec=1)(kr(jf,1),jf=1,limprm2+lenb2)
      write(7,6111,rec=2)(kr(jf,2),jf=1,limprm2+lenb2)
6111  format(60000i9)


      print *,'end y stage'
      if (kjbeg.ne.3)goto 55555
...
!     start of big loop      
      ...
      read(7,6111,rec=1)(kr(jf,1),jf=1,limprm2)
      read(7,6111,rec=2)(kr(jf,2),jf=1,limprm2)
...
!     instruction changes for small prime variant  limit incr. by 4    
      vimprm2=mimprm2
      if (krecarr(kz).gt.vimprm2)goto 690
!     compute accurately      
...
9777  do jf=1,kcarr(2)+2
      ...
      ijdpr,idpr1,idpr2,jdpr1,jdpr2,iconr,ispecp,limprm2,lvim,itypp)
...
61112 karr(2)=ilen3
      ...
      kr(limprm2+iccz-kkb+1,1)=isum
      kr(limprm2+iccz-kkb+1,2)=idpr1*10000+idpr2-isum
      ...
      kr(limprm2+iccz,1)=isum
      kr(limprm2+iccz,2)=jdpr1*10000+jdpr2-isum
      goto 690
...
7303  do jf=1,narr(1,2)+2
      ...
      if (itypp.eq.0)goto 55555
      if (iconq.gt.11)goto 55555
      if (irecdif.eq.0)goto 15 
      
      if (mod(iconq,2).eq.0)goto 55555
      if (iconr-irek2.ge.12)goto 55555
15    irek2=iconr
      kjbeg=limprm2+1
      kjbeg2=kjbeg
      iccn=limprm+1
...
730   print *,'run completed',' no of records=',irecnn,'irecone=',irecone
      ...
      print *,'iccz',iccz,'imatc',imatc,'ijdpr',ijdpr,'iconr',iconr
      ...
      write (10,10111,rec=1)iconr,ispecp,limprm,limprm2,mimprm,lenb2,&
      (n(jf),jf=1,60),izer1,izer2,ipr(limprm2),nizz,lmat1,nmat1,nmat2
      write (9,91111,rec=1)(ibbp(jl),jl=1,lenb2)
      
10111 format(2i6,i8,i8,i3,i6,60i4,3i6,i8,3i6)
91111 format(40000i9)      
      close (unit=8)
      close (unit=2)
      close(unit=3)
...
!     finish of calculation of number to be sieved
      ...
      ,'iconq',iconq,'iconr',iconr,'ispecp',ispecp
      do i=1,50
