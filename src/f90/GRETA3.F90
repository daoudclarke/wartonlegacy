...
!     compactification routine for MPQS for upto 80 digits      
      ...
      dimension ibbp(20000),nbbp(20000),n(60)
...
400   close(unit=4) 
      ...
      kkll=kkll*100+100
      kkll2=kkll+97
      open(unit=4,file='gretf4',access='direct',form=&
      'formatted',recl=kkll2,status='old')

!      read(4,499,rec=2)kkb,iconl,ihitn,(littr(jf),jf=1,20),(nar(iz),&
!      iz=1,kkll)
!      print *,'ijfk',ijfk,'ihitn',ihitn,'littr',(littr(jf),jf=1,20),&
!      'iconl',iconl,'kkb',kkb,'kkll',kkll,'nar',(nar(iz),iz=1,kkll)
!      do ihh=1,kkll
!      if (nar(ihh).eq.0)goto 2001
      
!      if (nar(ihh).eq.1)goto 2001
!      print *,'error nar',nar(ihh)
!      stop
!2001  end do
...
401   do i=1,kkll
      ...
      print *,'ok1',' kkll',kkll,'kkll2',kkll2,'lenb1',lenb1,'lenb2',lenb2
...
925   a=a
      ijfk=ijfk+1
      print *,'ijfk',ijfk,'ihitn',ihitn,'littr',(littr(jf),jf=1,20),&
      'iconl',iconl,'kkb',kkb,'kkll',kkll
      do ihh=1,kkll
      if (nar(ihh).eq.0)goto 2000
      if (nar(ihh).eq.1)goto 2000
      print *,'error nar',nar(ihh)
      stop
2000  end do
      print *,'ijfk',ijfk
      
      write(4,499,rec=ijfk)kkb,iconl,ihitn,(littr(jf),jf=1,20),(nar(iz),&
      iz=1,kkll)
...
500   close(unit=2)
      ...
      do jj=1,irecnn
      print *,'jj',jj
      read (4,499,rec=jj)kkb,narc,ihitn,(littr(jf),jf=1,20),(nar(i),i=1,kkll)
      print *,'narc',narc
      iconl=kmx1+narc-1
      nar(iconl)=1
...
378   end do
      ...
      write (4,499,rec=jj)kkb,narc,ihitn,(littr(jf),jf=1,20),&
      (nar(i),i=1,kkll)
