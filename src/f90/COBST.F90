      ...
      irecnn=0
      ipoin=0
      open(unit=2,file='newhits2',access='sequential')
      
      
      open(unit=4,file='hits3',access='sequential')
      n=1
...
414   end do
      ...
      (nar2(j),j=1,kmx2),(izzy(jl),jl=1,40)
499   format(i6,i6,1i1,191i1,284i1,40i1)
      goto 401
