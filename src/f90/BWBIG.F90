...
22     end do
       ...
       do lop =1,idegr +1
       print *,'darrays',idbarr(lop,1),idbarr(lop,2),idbarr(Lop,3)
       end do
       do i=1,idd
...
30     do k =1,idegm
       ...
       do i=1,idd
       print *,mat2(i,1),mat2(i,2),mat2(i,3),irhs2(i)
       end do
...
!      perform lifts
       ...
       do i =1,idegm
       mult1(i) =ipow -mult1(i)
       end do
       mult1(idd) =3-mult1(idd)
       if (mult1(idd).ge.0)goto 40
       mult1(idd) =mult1(idd) +ipow
40     do i =1,idd
       mult2(i) =isol(i)
       end do
       call multy(idegm,idegn,ipow)
       ...
       do i =1,idd
       isol(i) =mod(isol(i),ipow)
       if (isol(i).ge.0)goto 50
       isol(i) =isol(i) +ipow
50     end do
       end do
       print *,'mainsols',isol(1),isol(2),isol(3)
       stop
!      check square root
       do i =1,idd
       mult1(i)=isol(i)
       ...
       print *,'mainchecks',isol(i),isol(2),isol(3)
...
1000   end
       ...
       ip(i) = ip(i) + ipd
1      end do
       print *,'ips',ip(1),ip(2),ip(3),ip(4),ip(5),ip(6)
