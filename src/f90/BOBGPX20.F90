      ...
      program bobgpx20
!     derivative of bobgpx2 prepares for kernel calculation mod2      
      ...
      dimension npr1(8000),npr2(8000),nar(8000),nar2(8000)
      dimension littr(20),normar(20),iabp(50),iabpn(50),ity(50)
      dimension izzy(100),nh(60),ipd(50),narr(50),nbarr(50)
...
1006  format (60i4)      
      ...
      print *,'iabp',(iabp(jf),jf=1,icur),'littr',littr(1)
...
54    end do
      ...
      20),(nar(i),&
      i=1,kmx1),(nar2(j),j=1,kmx2+iconq)
...
499   format(i1,i10,20i4,5000i4,5000i4)
      goto 401
500   a=a
      irecnn=1
      norec=2
