...
!       common ncom(2,100),iprar(50),iansar(50),narc(50)
       ...
       dimension n(100),ipol(10,50),igg1(10,50),igg2(10,50),nfsol(10,50)
       dimension nn(50),ie(50)
       issz=0
       ncony=0
       nfcon=0
       ibbsw=0
...
!       stop
       ...
       goto 41
41     a=a       
       print *,'degree of polynomial and length of mod'
       read *,ipold,ipd(2)
       print *,'modulus'
       read *,(ipd(jf),jf=3,ipd(2)+2)
       icxy=2
       print *,'coeff 1'
       read *,(ipol(1,jf),jf=1,ipd(2)+2)
       print *,'coeff 2'
       read *,(ipol(2,jf),jf=1,ipd(2)+2)
       print *,'coeff 3'
       read *,(ipol(3,jf),jf=1,ipd(2)+2)
       do i=1,3
       do j=1,ipol(i,2)+2
       igarray(i,j)=ipol(i,j)
       end do
       end do


       
       if (icxy.eq.ipold)goto 700
       icxy=3
       print *,'coeff 4'
       read *,(ipol(4,jf),jf=1,ipd(2)+2)
       if (icxy.eq.ipold)goto 700
       icxy=4
       print *,'coeff 5'
       read *,(ipol(5,jf),jf=1,ipd(2)+2)
       if (icxy.eq.ipold)goto 700
       icxy=5
       print *,'coeff 6'
       read *,(ipol(6,jf),jf=1,ipd(2)+2)
       if (icxy.eq.ipold)goto 700
...
!       common ncom(2,100),iprar(50),iansar(50),narc(50)
       ...
       dimension n(100),ipol(10,50),igg1(10,50),igg2(10,50),iapar(50)
...
!       common ncom(2,100),iprar(50),iansar(50),narc(50)
       ...
       dimension iran(20),nnumb1(50),nnumb2(50),nnumb3(50)
       dimension nnumb4(50),nnumb5(50)
       dimension ninv(50),iprar(50),nsol(2,50),ixold(6,25),ixnew(6,25)
       dimension ipol1(6,25),ipol2(6,25),ipowr(5,6,3),jxold(6),jxnew(6)
       dimension itemp(50)
       print *,'igarray',igarray(1,1),igarray(1,2),igarray(1,3)
       print *,'igarray',igarray(2,1),igarray(2,2),igarray(2,3)
       print *,'igarray',igarray(3,1),igarray(3,2),igarray(3,3)
