...
!     compactification routine for quadratic sieves      
      ...
      dimension kpr1(5000),mpr1(5000)
      dimension npr1(5000),nar(5000)
      ...
      irecnn=0
      ipoin=0
      open(unit=2,file='newfax1',access='sequential')
      
      
      open(unit=4,file='faxm2',access='sequential')
      n=1
