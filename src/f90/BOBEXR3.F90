...
!       read (2,2,rec=1)((iv(ir,jf),jf=1,ipd(2)+2),ir=1,nzz)
!       print *,'iv',((iv(ir,jf),jf=1,ipd(2)+2),ir=1,20)
       
       read (1,1,rec=20)kkb,ihitn,(littr(jf),jf=1,20),&
...
74     mm=nzz
       ...
       ((nar(jk,jf),jf=1,ipd(2)+2),jk=1,kkll)
       if (i.ne.1)goto 998
       print *,'nar1 4',(nar(4,jf),jf=1,ipd(2)+2)
998    do jf=1,nar(1,2)+2
       marr(jf)=nar(1,jf)
       end do
       do jf=1,iv(i,2)+2
       mbarr(jf)=iv(i,jf)
...
34     jpiv(k)=j    
       ...
       print *,'inverse',(mul(jf),jf=1,mul(2)+2)
       do i=k,nunit
       do jf=1,iqi(i,j,2)+2
       kbarr(jf)=iqi(i,j,jf)
       end do
...
42     end do
       ...
       nq=1,mm)
       write(2,2,rec=ir)((iv(nq,jf),jf=1,ipd(2)+2),nq=1,mm)
2      format(5000(20i4))     
