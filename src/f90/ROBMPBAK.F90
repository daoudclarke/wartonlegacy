      ...
      program robmpbak 
!     final MPQS program for  60 digit numbers AVOIDING DIVISION    
!     smaller sieving interval
      ...
      dimension kr(15000,2),mm(20),mres(20),n(50),msqr(20)
      dimension mmsq(20),mstem(20),zlog(10000)
      dimension iaeq(50),ibeq(50),iceq(50),ninv(50),ixx(5)
      dimension ibbeq(50),kkm(15000,2),kcalc(15000,2)
      ...
      open(unit=2,file='equat',access='direct',form=&
...
668   do kz=1,10000
      ...
      if (krecarr(kz).gt.100.0)goto 690
!     compute accurately      
...
720   print *,'maximum no of primes=',kkmx
      ...
      (ixyz,jk),jk=1,50)
      if (irecnn.gt.5000+iconq-1)goto 730
