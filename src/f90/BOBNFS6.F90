      ...
      program bobnfs6
! generalisation of bobalgm
      character*200 istring,ostring
      character(200)gstring
      character*1 loc(200)
       common ibarray(12,5000),isarray(12,5000),igarray(12,5000),inv(25)
       common ibden(12,5000),isden(12,5000),igden(12,5000),irden(6,5000)
       common mult1(12,5000),mult2(12,5000),mult3(12,5000),mult4(12,5000)
       common mult5(12,5000)
       ...
       common iarq(2),ncom(2,100),irarray(6,5000),jpol(10,50),jpol2(10,50)
       common iqt(6,5000),ipd(50),iqtden(6,5000)
       common marr(5000),mbarr(5000),mcarr(5000),mdarr(5000),nnh(50)
       common ihalf(50)
!       common ncom(2,100),iprar(50),iansar(50),narc(50)
      ...
      common kden1(6,5000),kden2(6,5000),kden3(12,10000)
      dimension idrv5(5),idrv4(5),idrv3(5),idrv2(5),idrv1(5)
      dimension match(20000),iv(10000)
      dimension ksm(12,5000),ktemp(5,20),ktempl(5),kres(5000),kdenres(5000)
      dimension iyew(6,5000),nar(5000),nartot(10000),ivee(6,5000)
      dimension kktem(2,100),n(100),nar2(10000)
      iyes=0
      ino=1
      ivdeg=0
      ivee(1,1)=0
      ivee(1,2)=1
      ivee(1,3)=1
      open (unit=8,file='nfspar',access='direct',form=&
      'formatted',recl=488,status='old')
601   format (30i4,80i4,6i8)      
      read(8,601,rec=1)(n(jf),jf=1,30),(ia5(jf),jf=1,10),(ia4(jf),jf=1,10),& 
      (ia3(jf),jf=1,10),(ia2(jf),jf=1,10),(ia1(jf),jf=1,10),&
      (ia0(jf),jf=1,10),(m1(jf),jf=1,10),(m2(jf),jf=1,10),irecper,&
      klim,kkll,izz4,kmx1,mz
      kkll2=13+kkll
      
      print *,'irecper',irecper,'klim',klim,'kkll',kkll,'kmx1',kmx1,'mz',mz
     ...
     open (unit=5,file='nfsf4',access='direct',form=&
      'formatted',recl=kkll2,status='old')
      read (5,398,rec=1)kia,kib,isgn,(nar(i),i=1,kmx1),&
      (nar2(j),j=1,kkll-kmx1)
398   format (i6,i6,i1,10000i1)      
...
66    a=a       
      ...
      'formatted',recl=mz,status='old')
!      read(1,1,rec=2)(iv(ii),ii=1,mz)
!      isum=0
!      ifnd=1946
!      do ijj=1,mz
      
!      read (5,398,rec=ijj)kia,kib,isgn,(nar(i),i=1,kmx1),&
!      (nar2(j),j=1,kkll-kmx1)
      
!      isum=isum+nar2(ifnd)*iv(ijj)
!      end do
!      print *,'ijj',ijj,'isum',isum
!      stop
...
3     read(2,2,rec=1)(match(ii),ii=1,mm*2)
      ...
      read (5,398,rec=i)kia,kib,isgn,(nar(ij),ij=1,kmx1),&
      (nartot(j),j=1,kkll-kmx1)
      ktempl(1)=ia5(2)
      ione =i
      do ii=3,ia5(2)+2
      karr(ii-2)=ia5(ii)
      ...
      ktempl(j)=ilen3
      print *,'ktempl',j,ktempl(j),'ktemp',(ktemp(j,jk),jk=1,ilen3)
      end do
...
214   if(ia0(2).eq.0)goto 216
      ...
      print *,'kmpol2',(kmpol(2,jf),jf=1,kmpol(2,2)+2)
      print *,'kmpol3',(kmpol(3,jf),jf=1,kmpol(3,2)+2)
      print *,'kmpol4',(kmpol(4,jf),jf=1,kmpol(4,2)+2)
      print *,'kmpol5',(kmpol(5,jf),jf=1,kmpol(5,2)+2)
      print *,'kmpol6',(kmpol(6,jf),jf=1,kmpol(6,2)+2)
...
!      print *,'idegm',idegm,kdoub1(1,1),kdoub1(1,2),kdoub1(1,3)
      ...
      read (5,398,rec=i)kia,kib,isgn,(nar(ij),ij=1,kmx1),&
      (nar2(j),j=1,kkll-kmx1)
      print *,'i',i,'icc',icc,'iyewl',iyew(1,2),'iveel',ivee(1,2)    
      do ii=3,ia5(2)+2
      karr(ii-2)=ia5(ii)
      end do
      ilen=ia5(2)
...
43    end do
      ...
      print *,'yesses',iyes,'noes',ino,'iyewl',iyew(1,2),&
      'iveel',ivee(1,2)
...
555   end do
      ...
      write(3,1003,rec=i)(kdoub3(i,jf),jf=1,5000)
      end do
      do i=1,idprod+1
...
1004  format(20i4) 
      ...
      do ii=1,idprod+1
      do jf=1,ivee(ii,2)+2
      kdoub3(ii,jf)=ivee(ii,jf)
      end do
      end do
      do ii=1,idprod+1

      write (7,1003,rec=ii)(kdoub3(ii,jf),jf=1,5000)
      end do
...
!       common ncom(2,100),iprar(50),iansar(50),narc(50)
      ...
      common kden1(6,5000),kden2(6,5000),kden3(12,10000)
       ...
       dimension iws(12,5000),iwb(12,5000),itempb(12,5000),mul(5000),ib(5000)
       dimension iwsden(12,5000),iwbden(12,5000),mulden(5000)
       dimension itemp1(5000),itemp2(5000),itemp3(5000),itemp4(5000)
       dimension itemp5(5000)
!       print *,'ibar',((ibarray(jf,jk),jk=1,ibarray(jf,2)+2),&
!       jf=1,idegb+1)
!       print *,'isar',((isarray(jf,jk),jk=1,isarray(jf,2)+2),&
!       jf=1,idegs+1)
...
!       common n(100),jaa(100),jbb(100),kbcorn(200),kycorn(120)
      ...
      dimension karae(1000),karde(1000),karpe(1000),karh(1000),ktemp(1000)
