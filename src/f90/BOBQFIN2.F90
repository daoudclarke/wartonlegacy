      ...
      program bobqfin2
!     final quadratic sieve program for 60 digit number     
      ...
      common ipr(65000),norma(20),gpr(20000)
      common kara(50),karb(50),kard(50),karp(50),karv(50)
      common ncom(20)
      dimension kr(20000,2),mm(20),mres(20),n(20),msqr(20)
...
111   read(4,*,end=112)irecnn      
      read(4,*)irecnn
      goto 111


112   print *,'irecnn=',irecnn
...
5130  itemp=0
      goto 5142
5140  itemp=irrr(1)
5142  kr(i,kf)=kr(i,kf)-itemp
      if (kr(i,kf).ge.0)goto 5150
      kr(i,kf)=kr(i,kf)+ipr(i)
5150  end do      
      end do
      print *,'krs',(kr(jf,1),ipr(jf),jf=3,20)
...
663   kbarr(1)=0
      kbarr(2)=3
      kbarr(3)=int(icdn/10000)
      kbarr(4)=icdn-kbarr(3)*10000
      kbarr(5)=0
      goto 651
...
2020   call mpmul(ilen,ilen2,ilen3)
       print *,'ixit',kcarr(1),'ilen3',ilen3,'ilen',ilen,'ilen2',ilen2
       do jf=1,ilen3
       karr(jf)=kcarr(jf)
       end do
       ilen=ilen3
