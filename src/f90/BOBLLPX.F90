      ...
      program bobllpx 
!     generalization 1 :program uses linear number field sieve
...
!      print *,'start of last phase'
      print *,'im1',(im1(jf),jf=1,im1(2)+2),'kib',kib
      print *,'im2',(im2(jf),jf=1,im2(2)+2)
...
4101  a=a    
      ...
      isgn=1
      if (kia.ge.0)goto 4102
      
      
      goto 4103
4102  isgn=0
4103  kiatm(1)=mod(ic1(1)+isgn,2)
      do jf=3,ic2(2)+2
      kbarr(jf-2)=ic2(jf)
      end do
      ilen2=ic2(2)
...
!      if ((rel2.gt.lglm).or.(rel3.gt.lglm))goto 690
      print *,'norma0',(norma0(jf),jf=1,norma0(2)+2),'kia',kia,'kib',&
      kib
