      ...
      program yobmpbak 
!     first of two stages of MPQS TRIPLE large prime variant procedures   
...
9777  do jf=1,kcarr(2)+2
      ...
      ijdpr,idpr1,idpr2,jdpr1,jdpr2,kdpr1,kdpr2,ijktpr)
...
61112 karr(2)=ilen3
      ...
      kr(20000+iccz-kkb+2,1)=isum
      kr(20000+iccz-kkb+2,2)=jdpr1*10000+jdpr2-isum
      if (kkb.eq.2)goto 690
      do jf=3,iback(2)+2
      karr(jf-2)=iback(jf)
      end do
      ilen=iback(2)
      ...
      kr(20000+iccz-kkb+3,1)=isum
      kr(20000+iccz-kkb+3,2)=kdpr1*10000+kdpr2-isum
...
730   print *,'run completed',' no of records=',irecnn,'irecone=',irecone
      ...
      kr(i,2)=itemp
7111  end do      
      print *,'iccz',iccz,'imatc',imatc,'ijdpr',ijdpr,'ijktpr',ijktpr 
...
1300  irecnn=irecnn+1
      ...
      ,'iconq',iconq ,'iccz',iccz,'ijdpr',ijdpr,'imatc',imatc,'ijktpr',ijktpr
...
4000  inlen=litd(2)
      ...
      if ((nfact1(2).gt.2).and.(nfact2(2).gt.2))goto 1500
      if ((nfact1(3).gt.120).and.(nfact2(3).gt.120))goto 1500
      ibigsw=1
      if (nfact1(2).ne.nfact2(2))goto 4002
      do jf=3,nfact1(2)+2
      if (nfact1(jf).gt.nfact2(jf))goto 4010
      if (nfact1(jf).lt.nfact2(jf))goto 4020
      end do
      goto 2002
4002  if (nfact1(2).lt.nfact2(2))goto 4020
4010  itz3=nfact2(3)*10000+nfact2(4)
      do jf=1,nfact1(2)+2
      litd(jf)=nfact1(jf)
      end do
      
      goto 2002
4020  itz3=nfact1(3)*10000+nfact1(4)
      do jf=1,nfact2(2)+2
      litd(jf)=nfact2(jf)
      end do
...
2011  nbbp(iccz)=nbbp(iccz)+1      
      ...
      if (ibigsw.eq.0)goto 1300
      nbbp(iten1)=nbbp(iten1)+1
      if (itz3.eq.itz)goto 4100
      kkb=kkb+1
      icur=icur+1
      iabp(icur)=itz3
      iabpn(icur)=iabpn(icur)+1
      jdpr1=itz3/10000
      jdpr2=itz3-jdpr1*10000
      
      goto 1300
4100  iabpn(icur)=iabpn(icur)+1
      imatc=imatc+1
      goto 1300
2012  do jf=1,iccz
...
2019  end do
      ...
      kkb=kkb+1
      print *,'ibbp',itz2
4200  if (ibigsw.eq.0)goto 1300
      if (itz3.eq.itz)goto 4202      
      if (itz3.eq.itz2)goto 4204
      kkb=kkb+1
      ijktpr=ijktpr+1
      icur=icur+1
      iabp(icur)=itz3
      ...
      ity(icur)=1
      kdpr1=itz3/10000
      kdpr2=itz3-kdpr1*10000
      print *,'kkb',kkb,'kdprs',kdpr1,kdpr2,'ibigsw',ibigsw
      
      do i=1,iccz
      if (itz3.ne.ibbp(i))goto 4206
      nbbp(i)=nbbp(i)+1
      imatc=imatc+1
...
4206  end do      
      ...
      goto 1300
4202  iabpn(icur-1)=iabp(icur-1)+1  
      imatc=imatc+1
      nbbp(iten1)=nbbp(iten1)+1
      goto 1300
4204  iabpn(icur)=iabpn(icur)+1
      nbbp(iten2)=nbbp(iten2)+1
      imatc=imatc+1
      goto 1300
2000  icur=icur+1
