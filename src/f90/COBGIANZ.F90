       program cobgianz
!      fast computation of rational square root       
       ...
       dimension irot(1000),iquot1(1000),igcd(1000)
       ...
       open(unit=5,file='recl.data',access='direct',form=&
       'formatted',recl=390000,status='old')
       read(5,1005,rec=1)(ipr(jf),jf=1,65000)
1005   format(65000i6)
       ibin(1)=0
       ibin(2)=0
       ibin(3)=1
...
!       do ihhh=3084,3098
!       ipd=ipr(ihhh)
!       call subbw6(ipd,ipr(3074),iv)
!       print *,'iv',iv,'ipd',ipd,'ipr3074',ipr(3074)
!       end do
!       stop
       kbarr(1)=1
       kbarr(2)=8769
