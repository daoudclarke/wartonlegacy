      ...
      program tobmpbak 
!     final MPQS program for  66 digit numbers AVOIDING DIVISION    
!     smaller sieving interval  and 5000 prime base
!     second application used on 68 digit no. with 8000 primes base      
      ...
      common ipr(65000),norma(50),gpr(20000)
      common kara(50),karb(50),kard(50),karp(50),karv(50)
      common ncom(50),iprar(50),iansar(50),narc(50)
      dimension kr(20000,2),mm(20),mres(20),n(50),msqr(20)
      dimension mmsq(20),mstem(20),zlog(10000)
      dimension iaeq(50),ibeq(50),iceq(50),ninv(50),ixx(5)
      dimension ibbeq(50),kkm(20000,2),kcalc(20000,2)
      dimension narr(2,50),nbarr(2,50),ncarr(2,50)
      
      real krecarr(10000),lglm
      open(unit=2,file='gquat',access='direct',form=&
      ...
      open(unit=4,file='rnx',access='sequential')
...
668   do kz=1,10000
      ...
      if (krecarr(kz).gt.94.0)goto 690
!     compute accurately      
...
9777  do jf=1,kcarr(2)+2
      ...
      kia=kz
      call sieve(kia,kkb,irecnn,kkmx,icdn,iconq)
...
69002 iprerec=irecnn
      ...
      (ixyz,jk),jk=1,50)
      if (irecnn.gt.8000+iconq-1)goto 730
