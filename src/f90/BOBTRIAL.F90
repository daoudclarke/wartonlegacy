      ...
      dimension mm1(10),mm2(10),mm3(10),mm4(10),iprod(50)
...
!      read *,mmm
!      print *,'enter code'
!      read *,(karr(jf),jf=1,mmm)
!      print *,(karr(jf),jf=1,mmm)
!      stop
       do jf=1,8192
       karr(jf)=1111
       end do
...
!       print *,'kcarrs',(irrr(jf),jf=1,irlen)
       print *,'irlen',irlen
       stop
       do jf=4,26
       kara(jf)=0
...
!      end do
      ...
      mm=3164
      open(unit=1,file='faxt',access='sequential')
      open(unit=2,file='rernel',access='direct',form=&
