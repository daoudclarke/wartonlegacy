...
!     in 2 dimensions      
      ...
      dimension iprecod(50),idy(400),idx(400),itab(40),iddf(30,50)
      dimension ixl(30,50),iyl(30,50),ixdf(80,30,50),iydf(80,30,50)
      iaa=31
...
!     create table of prime differences      
      ...
      if (ipr(iprc)-iprt2.gt.160)goto 20009
      isspw3=1
      itab(1)=(ipr(1)-iprt2)/2
      ipcon=itab(1)
      iccon=1
      do i=1,15
      if (ipr(iprc+i)-iprt2.gt.160)goto 20008
      iccon=i+1
...
20018 if ((ipr(iprc+1).eq.799999).and.(ipr(iprc+1)-ipr(iprc).gt.160))&
      goto 20019
      if ((iprc+1.eq.65000).and.(ipr(iprc+1)-ipr(iprc).gt.160))&
      goto 20019
      if (ipr(iprc+1)-ipr(iprc).gt.160)goto 820
      do i=1,16
      
      
      if (ipr(iprc+i).gt.l2)goto 940
      if (ipr(iprc+i)-ipr(iprc).gt.160)goto 2002
...
2200  irecnn=irecnn+1
      ...
      iprc=1
      if (ij.gt.16)goto 20023
      
!      if ((i.eq.1).and.(ipr(1)-iprt.gt.160))goto 820
      do j=ij,16
      if ((iprc.eq.1).and.(ipr(iprc)-iprt.gt.160))goto 20023
      
      if (ipr(iprc)-iprt.gt.160)goto 20021
