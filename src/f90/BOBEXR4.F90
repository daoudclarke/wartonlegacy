       program bobexr4
!      final generaslized exponent recovery program
...
!     theorem
      ...
      common marr(200),mbarr(200),mcarr(200),mdarr(200)
       ...
       dimension nar(5000),littr(20),mpiv(5000,20),itex(20)
...
1      format (5000i4)       
       open (unit=3,file='texp1',access='sequential')
       ...
       read (2,2,rec=1)((iv(ir,jf),jf=1,ipd(2)+2),ir=1,mm)
...
499   format (i1,i10,20i4,5000i4)
       ...
       lsum(2)=0
       do i=1,mm
       read (4,499,rec=i)kkb,ihitn,(littr(jf),jf=1,20),(nar(jf),jf=1,kkll)
       if (i.ne.1)goto 497 
       print *,'nar1',(nar(jf),jf=1,20)
497    a=a
!       if (i.eq.1)goto 498
       if (nar(4).eq.0)goto 498
       marr(1)=0
       marr(2)=1
       marr(3)=nar(4)
       do jf=1,ivad(i,2)+2
