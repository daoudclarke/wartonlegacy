      ...
      program bobexr2
!     second generalized exponent recvery program
!      fastest matrix generation program
      ...
      dimension kpr1(40000),mpr1(40000)
      dimension npr1(40000),nar(3000,20),nh(60),ipd(60)
      dimension littr(20),normar(20),iabp(50),iabpn(50),ity(50)
      dimension izzy(100),narr(50),nbarr(50),jfak(30),jfreq(30)
      dimension ibase(50),jbase(50),itarg(50),jtarg(50)

      irecnn=0
      ipoin=0
      open(unit=2,file='texp3',access='sequential')
      ...
      read (9,1006,rec=1)(nh(jf),jf=1,60) 
1006  format(60i4)      
      do jf=1,nh(2)+2
      karr(jf)=nh(jf)
      end do
...
33    write(2, *)irecnn,kkb,ihitn,kmx1,(littr(jf),jf=1,20)      
      write(2, *)irecnn,(kpr1(j1),j1=1,kmx1),(iabpn(jf),jf=1,kmx1)
...
100   read(4,*,end=400)irecnn,kkb,ihitn,icur,(littr(j1),j1=1,20)
      ...
      read(4,*)irecnn,(iabp(i),iabpn(i),ity(i),i=1,icur)
!      print *,'irecnn',irecnn,'icur',icur,'primes',(iabp(jf),jf=1,icur),&
!      'freqs',(iabpn(jf),jf=1,icur)
!      if (irecnn.ne.8)goto 1020
...
133   write(2, *)irecnn,kkb,ihitn,mmx1,(littr(jf),jf=1,20)
      write(2, *)irecnn,(mpr1(j1),j1=1,mmx1),(iabpn(jf),jf=1,mmx1) 
...
!     margin of safety here      
      kkll=kmx1+10
! following 2  insts are only temporary      
      itwist=ipd(2)
      ipd(2)=18
      kkll2=kkll*4*(ipd(2)+2)+91
      print *,'kkll2',kkll2,'ipdl',ipd(2),'kkll',kkll
!      open(unit=1,file='bexp1',access='direct',form=&
!      'formatted',recl=kkll2,status='replace')
     print *,'ok1'
...
401   do i=1,kkll
      ...
      read(2, *)irecnn,(mpr1(j1),j1=1,mmx1),(iabpn(jf),jf=1,mmx1)
!      print *,'littr',(littr(jm),jm=1,20)
      jnd=1
      do i=1,mmx1
      do j=jnd,kmx1
...
404   end do
      ...
      write(1,499,rec=irecnn)kkb,ihitn,(littr(jf),jf=1,20),&
      ((nar(i,jf),jf=1,ipd(2)+2),i=1,kkll)

499   format(i1,i10,20i4,5000(20i4))
      goto 401

      
500   close(unit=2)
      close(unit=1)
! temporary inst to avoid overwriting file      
      goto 12345
      open (unit=3,file='exppar',access='direct',form=&
      'formatted',recl=344,status='old')
      ixyz1=0
      ixyz2=0
      read (3,1003,rec=1)ixyz1,ixyz2,ijpow,nfak,(ibase(jf),jf=1,20),&
      (jbase(jf),jf=1,20),(itarg(jf),jf=1,20),(jtarg(jf),jf=1,20)
      irecnn=1470
      kkll=1463
      write (3,1003,rec=1)irecnn,kkll,ijpow,nfak,(ibase(jf),jf=1,20),&
      (jbase(jf),jf=1,20),(itarg(jf),jf=1,20),(jtarg(jf),jf=1,20)
1003  format (i6,i6,i8,i4,20i4,20i4,20i4,20i4)      
12345 a=a      
      ipd(2)=itwist
      print *,'ipd',(ipd(jf),jf=1,ipd(2)+2),'irecnn',irecnn,'kkll',kkll
      end
