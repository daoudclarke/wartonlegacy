...
!     elliptic curve method multiple parallel inverses phase 1 and 2
      ...
      dimension ixl(30,50),iyl(30,50),ixdf(50,30,50),iydf(50,30,50)
      iaa=61
...
!      goto 4993
      read (2,4992,rec=87)(ipr(jf),jf=1,65000)
      print *,(ipr(jf),jf=64900,65000),'ipr1',ipr(1)
     stop 
...
8081  idcn=ipr(iprc)-ipr(iprc-1)
      if (idcn.gt.100)goto 820
      idcn=idcn/2
      do i=1,30
      do jf=1,ixdf(idcn,i,2)+2
      ix2(i,jf)=ixdf(idcn,i,jf)
      end do
      do jf=1,iydf(idcn,i,2)+2
      iy2(i,jf)=iydf(idcn,i,jf)
      end do
      end do
      ibbsw=4
      goto 1601
809   do i=1,30
      ...
      if (ipr(iprc).eq.799999)goto 900
      iprc=iprc+1
      if (ipr(iprc).gt.l2)goto 940
      print *,ipr(iprc),idcn
      goto 8081
810   if (ipr(iprc).eq.799999)goto 900
      iprc=iprc+1
      if (ipr(iprc).gt.l2)goto 940
      goto 808
820   do i=1,30
...
900   irecnn=irecnn+1
      if (irecnn.eq.16)goto 600
      read(2,4992,rec=irecnn)(ipr(jf),jf=1,65000)
      iprc=1
      if (ipr(iprc).gt.l2)goto 940
      icdn=ipr(1)-iprdl
9001  if (icdn.gt.100)goto 920
      icdn=icdn/2
      do i=1,30
      do jf=1,ixdf(icdn,i,2)+2
      ix2(i,jf)=ixdf(icdn,i,jf)
      end do
      do jf=1,iydf(icdn,i,2)+2
      iy2(i,jf)=iydf(icdn,i,jf)
      end do
      end do
      ibbsw=5
      goto 1601
