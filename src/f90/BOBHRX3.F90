       program bobhrx3
!      program for finding prime polynomials
!      outputs prime polynomials on file 'prpol'     
!      polynomials. finds all roots of equations of degree 5 and less with       
!      modulus less than 44000
       common ibarray(1000),isarray(1000),igarray(1000),inv(25)
       ...
       common iarq(2),ncom(20),irarray(1000),jpol(10),jpol2(10),iqt(10)
       
       
       
       dimension n(100),ipol(10),igg1(10),igg2(10),nfsol(10)
       dimension ipolpr(300,20),itab(100)
       open (unit=1,file='prpol',access='sequential')
       ipd=2
       ipdp=8
!       goto 41
       do jf=1,11
...
601    idegb=ii
       ...
       llim=ii/2
602    a=a
! 602    print *,'ibar',(ibarray(jl),jl=1,idegb+1)

       do jj=1,itab(llim)
       idegs=ipolpr(jj,1)-1
       do jf=1,idegs+1
       isarray(jf)=ipolpr(jj,jf+1)
       end do
       call subbw4(idegs,idegb,idegg,ipd)
       

609    if (idegg.eq.-1)goto 600
       
       end do
       iconp=iconp+1
       ipolpr(iconp,1)=idegb+1
       leng=idegb+1
       do jf=1,idegb+1
       ipolpr(iconp,jf+1)=ibarray(jf)
       end do
       write(1,*)iconp,leng
       write(1,*)iconp,(ibarray(jf),jf=1,leng)
       print *,'prime poly',(ibarray(jf),jf=1,leng)
       do jf=2,ii
       if (ibarray(jf).eq.0)goto 600
       end do
       
!       if (iconp.ge.90)goto 610
       goto 607
600    do j2=ii+1,2,-1
       ibarray(j2)=mod(ibarray(j2)+1,2)
       if (ibarray(j2).eq.1)goto 602
       end do
...
607    a=a
       itab(idegb)=iconp
       ii=ii+1
       print *,'increase degree',ii
       if (ii.eq.7)goto 610
       goto 601
610    close (unit=1)
       print *,'no. of prime polynomials=',iconp,'max deg=',idegb 
       stop
...
1000   print *,'nfcon',nfcon,'sols',(nfsol(jf),jf=1,nfcon)       
       ...
       dimension n(100),ipol(10),igg1(10),igg2(10)
       idegp=1
       iapar=1
61     igg1(1)=1
       igg1(2)=iapar
...
400    a=a              
       ...
       dimension iws(105000),iwb(105000),itempb(105000),mul(4)
       icon=0
       ipdc=2000000000/ipd
...
890    return
       ...
       common kara(50),karb(50),kard(50),karp(50),karv(50)
       common iarq(2),ncom(20),irarray(1000),jpol(10),jpol2(10),iqt(10)
       dimension iws(1000),iwb(1000),itempb(1000),mmul(10)
