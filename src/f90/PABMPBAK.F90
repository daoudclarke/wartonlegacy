...
!     sieving for large numbers,single & double GNFS sieves     
      ...
      common kr(10001,10),kndx(78000),krecarr(78000),zlog(10000),ipol1(6,50)
      common mrecarr(1000),mndx(1000)
      dimension iprar(4),invarr(4500)
      real krecarr,lgpr(10001),lglm ,mrecarr
      open (unit=7,file='invers',access='direct',form=&
      'formatted',recl=22500,status='old')
...
!      read (2)kr
      ...
      do iz2=1,10
      read (1,12347,rec=iz2)(kr(iz,iz2),iz=1,4500)
      end do
...
12349 do i=2,4500
      ...
      do kib=12,isivl
      call fscomp(kib,vlgls,ispecp,ispeca,kspec,vkazer,2,lml,lmr)
      do ibz=150,50,-1
...
20003 ispecp=ipr(ibz)
      ...
      mndx(1)=1
      mndx(2)=1
      call fscomp(kib,vlgls,ispecp,ispeca,kspec,vkazer,4,lml,lmr)
!      print *,'hello1'
      ifunp=ibz
      iconf=0
      do jbz=2,4500
...
3604  markm=markb
      markbn=ipr(iz)-markb
36041 if ((markb.gt.lmr).and.(markbn.gt.lml))goto 3615
      if ((markb.gt.lmr).or.(markb.eq.0))goto 3606
      if (mndx(markb*2-1).ne.1)goto 3606
      mrecarr(markb*2-1)=mrecarr(markb*2-1)-lgpr(iz)
!      print *,'mrecarr1',mrecarr(markb*2-1)
3606  if ((markbn.gt.lml).or.(markbn.eq.0))goto 36062
      if (mndx(markbn*2).ne.1)goto 36062
      mrecarr(markbn*2)=mrecarr(markbn*2)-lgpr(iz)
!      print *,'mrecarr2',mrecarr(markbn*2)
...
36051 if ((markl.lt.1).and.(markln.lt.1))goto 3615
      if ((markl.lt.1).or.(markl.gt.lmr))goto 3616
      mindm=markl+markl-1
      if (mndx(mindm).ne.1)goto 3616
      mrecarr(mindm)=mrecarr(mindm)-lgpr(iz)
!      print *,'mrecarr3',mrecarr(mindm)
3616   if ((markln.gt.lml).or.(markln.lt.1))goto 36162
      mindm=markln+markln
      if (mndx(mindm).ne.1)goto 36162
      mrecarr(mindm)=mrecarr(mindm)-lgpr(iz)
!      print *,'mrecarr4',mrecarr(markln*2)
...
3401  format(4000(i1,f9.5))      
      goto 16159
      call fscomp(kib,vlgls,ispecp,ispeca,kspec,vkazer,1,lml,lmr)
...
1615  end do
16159 call fscomp(kib,vlgls,ispecp,ispeca,kspec,vkazer,2,lml,lmr)
...
1500  return
      ...
      subroutine fscomp(kib,vlgls,ispecp,ispeca,kspec,vkazer,kjk,lml,lmr)
      common karr(50),kbarr(50),kcarr(200),ipqt(50),irrr(50)
      common mnum(50)
      common ia5(5),ia4(5),ia3(5),ia2(5),ia1(5),ia0(5),m1(5),m2(5)
      common ipr(65000),norma(20)
...
!      print *,'lmr',lmr
      itemm=itemm+ispecp
      itemd=itemm+itemm-1
      if (itemd.gt.78000)goto 211
      if (kndx(itemd).eq.0)goto 2111
      mrecarr(i)=krecarr(itemd)-vsub
!      print *,'itemd',itemd,'i',i,mrecarr(i)
2111  mndx(i)=kndx(itemd)
      kndx(itemd)=0
      end do
211   itemm=ispecp-ispeca
...
!      print *,'lml',lml
      itemm=itemm+ispecp
      itemd=itemm+itemm
      if (itemd.gt.78000)goto 212
      if (kndx(itemd).eq.0)goto 2121
      mrecarr(i)=krecarr(itemd)-vsub
2121  mndx(i)=kndx(itemd)
      kndx(itemd)=0
      end do
212   little=kib   
      ibbb=ispeca
      if (kndx(2*ispeca-1).eq.0)goto 220
      call subgcd(ibbb,little,igcd2)
      if (igcd2.ne.1)goto 220
      vkazer=krecarr(2*ispeca-1)-vsub
      kspec=1
      goto 100
220   kspec=0      
      goto 100
...
112   return
      ...
      common ipr(65000),norma(20)
      common kara(50),karb(50),kard(50),karp(50),karv(50)
      common kr(10001,10),kndx(80000),krecarr(80000),zlog(10000),ipol1(6,50)
      common mrecarr(1000),mndx(1000)
      real krecarr,mrecarr
