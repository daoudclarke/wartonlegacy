...
!     idis has positive value of negative discriminant      
      ...
      common mult1(5,2,600),mult2(5,2,600),mult3(5,2,600)
      common marr(2000),mbarr(2000),mcarr(2000),mdarr(2000)
      dimension idisarr(130),irecarr(1000),ireclen(150)
      idisarr(1)=7
      idisarr(2)=11
      idisarr(3)=19
      idisarr(4)=43
...
!     do mcon=1,icont+4
      ...
      iendic=1
      print *,'fbok'
      call submodj(iendic,1,ibpar,idis)
      idegm=1
...
112   end do
      ...
      print *,'run completed discrimanant count=',isuscon,'isus3',isus3
      close (unit=2)
      close (unit=1)
...
4     do jf=1,mcarr(2)+2
      ...
      common iarq(2)
      common jay(2,420),ipi(220),icurr(2000)
      common mult1(5,2,400),mult2(5,2,400),mult3(5,2,400)
      common marr(2000),mbarr(2000),mcarr(2000),mdarr(2000)
      do i=1,ilen+ilen2
      kcarr(i) =0
