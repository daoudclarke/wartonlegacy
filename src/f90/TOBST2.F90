      ...
      program tobst2
!     compactification routine for MPQS for 68 digit nos      
      ...
      irecnn=0
      ipoin=0
      open(unit=2,file='rnwfax1',access='sequential')
      
      
      open(unit=4,file='rnx',access='sequential')
      n=1
      open(unit=1,file='tompdatc',access='direct',form=&
      'formatted',recl=8991,status='old')
...
404   end do
      ...
      write(1,499,rec=irecnn)kkb,ihitn,(littr(jf),jf=1,20),(nar(i),i=1,8900)
      
499   format(i1,i10,20i4,8900i1)
      goto 401
...
500   close(unit=2)
      ...
      read (3,72222,rec=1)irecnn,iconq,(narr(jf),jf=1,50),(nbarr(jk),&
      jk=1,50)
      irecnn=0
      norec=2
      narc=8001
502   ibeg=irecnn+1
      ...
      iend=irecnn
      do jj=ibeg,iend
      read (1,499,rec=jj)kkb,ihitn,(littr(jf),jf=1,20),(nar(i),i=1,8900)
      nar(narc)=1
      write (1,499,rec=jj)kkb,ihitn,(littr(jf),jf=1,20),(nar(i),i=1,8900)
      end do
