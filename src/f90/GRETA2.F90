      ...
      program greta2
!     Generalisation
!      second of two stages of MPQS double large prime variant procedures   
...
!     also large prime variant extension      
      ...
      common ibbp(20000),nbbp(20000),ntest(50),nfact1(50)
      dimension kr(60000,2),mm(20),mres(20),n(50),msqr(20)
      dimension mmsq(20),mstem(20),zlog(10000)
      dimension iaeq(50),ibeq(50),iceq(50),ninv(50),ixx(5)
      dimension ibbeq(50),kkm(60000,2)
...
!      call bigb5(noyes)
      ...
      (n(jf),jf=1,60),izer1,izer2,lenb1,nizz,lmat1,nmat1,nmat2
10111 format (2i6,i8,i8,i3,i6,60i4,3i6,i8,3i6)      
      ...
      'formatted',recl=kkkl,status='old')
...
81111 format (20000i3)
      ...
      print *,'nbbp',(nbbp(jf),jf=1,lenb2)
      

      jconr=iconr
      read (7,6111,rec=1)(kr(jf,1),jf=1,limprm2+lenb2)
      read (7,6111,rec=2)(kr(jf,2),jf=1,limprm2+lenb2)
      print *,'kr1',(kr(limprm2+jf,1),jf=4980,4990)
      print *,'kr2',(kr(limprm2+jf,2),jf=4980,4990)
...
!     instruction changes for small prime variant      
      lglm=log10(rel) 
      do i=limprm2+1,limprm2+lenb2
      ipr(i)=kr(i,1)+kr(i,2)
      end do
      print *,'kaze1',(kr(jf,1),jf=21,50) 
      print *,'kaze2',(kr(jf,2),jf=21,50)
      ...
      do i=limprm2+1,limprm2+lenb2
      print *,'ipri',ipr(i)
      if (ipr(i).le.immyx)goto 92999
      print *,'immyx',immyx
      immyx=ipr(i)
92999 end do
      print *,'immyx',immyx,'lenb2',lenb2,'limprm2',limprm2
      if (immyx.le.1000000)goto 92998
      if (immyx.ge.100000000)goto 92998
      goto 92997
92998 print *,'limit outside bounds'
      stop
92997 itcp=immyx/10000
      itcp2=itcp*itcp
      lvim21=itcp2/10000
      lvim22=itcp2-lvim21*10000
      lvim=itcp
...
6111  format(60000i9)
      ...
      print *,'okk'
      read (2,72222,rec=1)ivxy,iconq
      read (2,72222,rec=iconq)ispar1,ispar2,(narr(1,ixyz),ixyz=1,50),&
      (nbarr(1,ixyz),ixyz=1,50)
      do jf=1,narr(1,2)+2
      karr(jf)=narr(1,jf)
      end do
      kbarr(1)=0
...
6101  if (ipr(jz).eq.2)goto 650
      if (kr(jz,2).eq.999999999)goto 650
...
9777  do jf=1,kcarr(2)+2
      ...
      ijdpr,idpr1,idpr2,jdpr1,jdpr2,jconr,ispecp,limprm2,lenb2,&
      lvim,lvim21,lvim22)
      goto 690
      
9778  if (kkb.eq.0)goto 690
...
69002 iprerec=irecnn
      ...
      (ixyz,jk),jk=1,50)
!      if (jconr.ge.5000)goto 730
      if (jconr.ge.limprm+ispecp+iconq-1)goto 730
...
730   print *,'run completed',' no of records=',irecnn,'irecone=',irecone
      ...
      print *,'iccz',iccz,'ijdpr',ijdpr,'lenb2',lenb2,'immyx',immyx
      print *,'iaeq',(iaeq(jf),jf=1,iaeq(2)+2)
      print *,'iconr',iconr,'jconr',jconr,'ispecp',ispecp,'iconq',iconq
      write (8,81111,rec=1)(nbbp(jf),jf=1,lenb2)
      write (10,10111,rec=1)jconr,ispecp,limprm,limprm2,mimprm,lenb2,&
      (n(jf),jf=1,60),izer1,izer2,lenb1,nizz,lmat1,nmat1,nmat2
      close (unit=8)
      close (unit=2)
      close(unit=3)
...
!     finish of calculation of number to be sieved
      ...
      ,'iconq',iconq,'iccz',iccz,'jconr',jconr,'ispecp',ispecp
      do i=1,50
...
1300  irecnn=irecnn+1
      ...
      ,'iconq',iconq ,'iccz',iccz,'ijdpr',ijdpr,'jconr',jconr,'ispecp',ispecp
...
1302  do i=1,20
      ...
      iconl=iconq+1
      write(4,*)irecnn,iconl,kkb,ihitn,icur,(littr(j1),j1=1,20)
...
1490  if (litd(2).gt.4)goto 1500      
      if ((litd(2).eq.2).and.(litd(3).le.lvim))goto 2000
      if (litd(2).lt.4)goto 2002
      if ((litd(3).eq.lvim21).and.(litd(4).le.lvim22))goto 2002
      if (litd(3).lt.lvim21)goto 2002
      goto 1500
2002  inlen=litd(2)
      do jf=3,litd(2)+2
      mnum(jf-2)=litd(jf)
      ...
      if ((nfact1(3).gt.lvim).or.(nfact2(3).gt.lvim))goto 1500
      itz=nfact1(3)*10000+nfact1(4)
      itz2=nfact2(3)*10000+nfact2(4)
      do i=limprm2+1,limprm2+lenb2
      if (itz.ne.ipr(i))goto 3000
      goto 3002
3000  end do      
      if (itz.ne.itz2)goto 1500
      jconr=jconr+1
      icur=icur+1
      iabp(icur)=itz
      iabpn(icur)=2
      ...
      print *,'ibbp',itz
      goto 1300
3002  if (itz.ne.itz2)goto 3010
      iccz=iccz+1
      jconr=jconr+1
      
      ilk=i-limprm2
      if (nbbp(ilk).ne.1)goto 3333
      jconr=jconr+1
      ispecp=ispecp+1
3333  nbbp(ilk)=nbbp(ilk)+2
      icur=icur+1
      iabp(icur)=itz
      iabpn(icur)=2
      ity(icur)=1
...
3022  iccz=iccz+2
      ...
      nbbp(jlk)=nbbp(jlk)+1
      nbbp(ilk)=nbbp(ilk)+1
      if (nbbp(jlk).ne.2)goto 202
      jconr=jconr+1
      ispecp=ispecp+1
202   if (nbbp(ilk).ne.2)goto 204
      jconr=jconr+1
      ispecp=ispecp+1
204   icur=icur+1
      iabp(icur)=itz
      ...
      print *,'ibbp',itz2
      goto 1300
2000  itz=litd(3)*10000+litd(4)
      do i=limprm2+1,limprm2+lenb2
      ilk=i-limprm2
      if (itz.ne.ipr(i))goto 2510 
      goto 2512
2510  end do
      goto 1500
2512  nbbp(ilk)=nbbp(ilk)+1
      jconr=jconr+1
      if (nbbp(ilk).ne.2)goto 206
      jconr=jconr+1
      ispecp=ispecp+1
206   icur=icur+1
      iabp(icur)=itz
