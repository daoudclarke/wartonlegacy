      ...
      program hobmid22
!     last program in quadratic sieve procedure for 54 and 60 digit nos.
      ...
      mm=8005
      open(unit=1,file='bax',access='sequential')
      open(unit=2,file='ternel22',access='direct',form=&
      'formatted',recl=40025,status='old')
      read(2,2,rec=3)(iv(jf),jf=1,mm)
      print *,'iv',(iv(jf),jf=7692,mm)
...
9992  iprod(1)=0
      ...
      read(1, *)irecnn,kkb,ihitn,icur,(numb2(jf),jf=1,20)
      read(1, *)irecnn,(iabp(jk),iabpn(jk),ity(jk),jk=1,icur)
      print *,'i',i,'ihitn',ihitn,'iv',iv(i),(iprod(jk),jk=1,iprod(2)+2)
      
      if (iv(i).eq.0)goto 199
      if (ihitn.lt.10000)goto 110
      if (ihitn.ge.100000000)goto 111
      kbarr(1)=0
      kbarr(2)=2
      kbarr(3)=int(ihitn/10000)
      kbarr(4)=ihitn-kbarr(3)*10000
      goto 112
111   kbarr(3)=int(ihitn/100000000)
      itemp=ihitn-kbarr(3)*100000000
      kbarr(4)=int(itemp/10000)
      kbarr(5)=itemp-kbarr(4)*10000
      kbarr(2)=3
      kbarr(1)=0
      goto 112
...
199   end do
      ...
      read(1, *)irecnn,(iabp(jk),iabpn(jk),ity(jk),jk=1,icur)
      print *,'i',i,'ihitn',ihitn,'iv',iv(i),(iprod(jk),jk=1,iprod(2)+2)
      if (iv(i).eq.0)goto 299
      if (ihitn.lt.10000)goto 210
      if (ihitn.ge.100000000)goto 211
      kbarr(1)=0
      kbarr(2)=2
      kbarr(3)=int(ihitn/10000)
      kbarr(4)=ihitn-kbarr(3)*10000
      goto 212
211   kbarr(3)=int(ihitn/100000000)
      itemp=ihitn-kbarr(3)*100000000
      kbarr(4)=int(itemp/10000)
      kbarr(5)=itemp-kbarr(4)*10000
      kbarr(2)=3
...
299   end do
      ...
      read(1, *)irecnn,(iabp(jk),iabpn(jk),ity(jk),jk=1,icur)
      print *,'i',i,'ihitn',ihitn,'iv',iv(i),(iprod(jk),jk=1,iprod(2)+2)
      if (iv(i).eq.0)goto 399
      if (ihitn.lt.10000)goto 310
      if (ihitn.ge.100000000)goto 311
      kbarr(3)=int(ihitn/10000)
      kbarr(4)=ihitn-kbarr(3)*10000
      kbarr(2)=2
      kbarr(1)=0
      goto 312
311   kbarr(3)=int(ihitn/100000000)
      itemp=ihitn-kbarr(3)*100000000
      kbarr(4)=int(itemp/10000)
      kbarr(5)=itemp-kbarr(4)*10000
      kbarr(2)=3
...
399   end do
      ...
      read(1 ,*)irecnn,(iabp(jk),iabpn(jk),ity(jk),jk=1,icur)
      print *,'i',i,'ihitn',ihitn,'iv',iv(i),(iprod(jk),jk=1,iprod(2)+2)
      if (iv(i).eq.0)goto 499
      if (ihitn.lt.10000)goto 410
      if (ihitn.ge.100000000)goto 411
      kbarr(3)=int(ihitn/10000)
      kbarr(4)=ihitn-kbarr(3)*10000
      kbarr(1)=0
      kbarr(2)=2
      goto 412
411   kbarr(3)=int(ihitn/100000000)
      itemp=ihitn-kbarr(3)*100000000
      kbarr(4)=int(itemp/10000)
      kbarr(5)=itemp-kbarr(4)*10000
      kbarr(2)=3
...
499   end do
      ...
      read(1, *)irecnn,(iabp(jk),iabpn(jk),ity(jk),jk=1,icur)
      print *,'i',i,'ihitn',ihitn,'iv',iv(i),(iprod(jk),jk=1,iprod(2)+2)
      if (iv(i).eq.0)goto 599
      if (ihitn.lt.10000)goto 510
      if (ihitn.ge.100000000)goto 511
      kbarr(3)=ihitn/10000
      kbarr(4)=ihitn-kbarr(3)*10000
      kbarr(1)=0
      kbarr(2)=2
      goto 512
511   kbarr(3)=ihitn/100000000
      itemp=ihitn-kbarr(3)*100000000
      kbarr(4)=itemp/10000
      kbarr(5)=itemp-kbarr(4)*10000
      kbarr(2)=3
