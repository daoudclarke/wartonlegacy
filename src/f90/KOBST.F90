      ...
      irecnn=0
      ipoin=0
      open(unit=2,file='kewhits2',access='sequential')
      
      
      open(unit=4,file='kits',access='sequential')
      n=1
...
414   end do
      ...
      (nar2(j),j=1,kmx2),(izzy(jl),jl=1,25)
499   format(i6,i6,1i1,67i1,106i1,25i1)
      goto 401
