      ...
      program robst2
!     compactification routine for MPQS for 60 digit nos      
...
404   end do
      ...
      write(1,499,rec=irecnn)kkb,ihitn,(littr(jf),jf=1,20),(nar(i),i=1,5300)
      
499   format(i1,i10,20i4,5300i1)
      goto 401

      
500   close(unit=2)
      open (unit=3,file='equat',access='direct',form=&
...
502   ibeg=irecnn+1
      ...
      iend=irecnn
      do jj=ibeg,iend
      read (1,499,rec=jj)kkb,ihitn,(littr(jf),jf=1,20),(nar(i),i=1,5300)
      nar(narc)=1
      write (1,499,rec=jj)kkb,ihitn,(littr(jf),jf=1,20),(nar(i),i=1,5300)
      end do
