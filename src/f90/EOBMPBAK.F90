...
400   ia=1
      ...
      read(1,3401,rec=100)(kndx(jf),krecarr(jf),jf=1,4000)
      print *,(krecarr(jf),jf=1,200)
...
!     change parameter      
      do iz=2,304
      do iz2=1,5
      if (kr(iz,iz2).eq.99999)goto 615
...
604   markm=markb
      markbn=ipr(iz)-markb
6041  if ((markb.gt.2000).and.(markbn.gt.2000))goto 615
