      ...
      program bobexp1 
!     generalization 1
!     first program in exponent recovery suite    
      ...
      dimension icurr(60),itab(40),jtab(40),ibase(50),jfreq(50),littr(20)
      dimension jbase(50),itarg(50),jtarg(50)
...
!     stop
      ...
      print *,'number of factors in target'
      read *,nfak
      print *,'input target factors'
      read *,(jfak(jf),jf=1,nfak)
      do jf=1,nfak
      jfakin(jf)=0
      end do
      print *,'input target factor frequencies'
      read *,(jfreq(jf),jf=1,nfak)
      print *,'length of base radix 10000'
      read *,ibase(2)
      print *,'input base here'
      read *,(ibase(jf),jf=3,ibase(2)+2)
      ibase(1)=0
      print *,'ibase1',(ibase(jf),jf=1,ibase(2)+2)
...
!      print *,'ok sofar irlen=',irlen
      ...
      call sieve(kia,kkb,irecnn,kkmax,icdn,iconq,limprm2)
      do jf=1,nfak
...
!      close (unit=2)
     ...
     'formatted',recl=344,status='replace') 
1002 format (i6,i6,i8,i4,20i4,20i4,20i4)      
