...
!     second generalized exponent recvery program
      ...
      dimension npr1(40000),nar(40000)
...
!     safety margin here      
      ...
      'formatted',recl=kkll2,status='new')
...
404   end do
      ...
      write(1,499,rec=irecnn)kkb,ihitn,(littr(jf),jf=1,20),(nar(i),i=1,kkll)
      

499   format(i1,i10,20i4,3000i10)
      goto 401
