      ...
      program wobmpbak 
!     first of two stages of MPQS large prime variant procedures   
...
!     instruction changes for small prime variant  limit incr. by 4    
      if (krecarr(kz).gt.93.0)goto 690
!     compute accurately      
...
9777  do jf=1,kcarr(2)+2
      ...
      kkb=0
      kia=kz
      call sieve(kia,kkb,irecnn,kkmx,icdn,iconq,iccz,imatc,npr1,npr2)
...
61112 karr(2)=ilen3
      ...
      kr(20000+iccz,2)=npr1*10000+npr2-isum
...
7111  end do      
      ...
      subroutine sieve(kia,kkb,irecnn,kkmx,icdn,iconq,iccz,imatc,npr1,npr2)
      common karr(50),kbarr(50),kcarr(200),ipqt(50),irrr(50)
      common mnum(50)
      common ia5(5),ia4(5),ia3(5),ia2(5),ia1(5),ia0(5),m1(5),m2(5)
      common ipr(65000),norma(50),gpr(65000)
