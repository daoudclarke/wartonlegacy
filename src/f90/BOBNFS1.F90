...
1000   end
       ...
       dimension kr(10000,10),n(50),lbase(50)
       do jf=1,50
       n(jf)=0
       end do
       ...
       close(unit=3)
       print *,'deg5 coeff.10 blocks?' 
       read *,(ia5(jf),jf=1,10)
       print *,'deg4 coeff. 10 blocks?'
       read *,(ia4(jf),jf=1,10)
       print *,'deg3 coeff. 10 blocks?' 
       read *,(ia3(jf),jf=1,10)
       print *,'deg2 coeff. blocks?'
       read *,(ia2(jf),jf=1,10)
       print *,'deg1 coeff. 10 blocks? '
       read *,(ia1(jf),jf=1,10)
       print *,'const. coeff. blocks?'
       read *,(ia0(jf),jf=1,10)
       print *,'m1 10 blocks?'
       read *,(m1(jf),jf=1,10)
       print *,'m2 10 blocks?'
       read *,(m2(jf),jf=1,10)
       print *,'code length blocks?'
       read *,n(2)
       print *,'code'
...
!       'formatted',recl=488,status='old')
       ...
       izz5=0
       izz6=0
       write (2,400,rec=1)(n(jf),jf=1,30),(ia5(jf),jf=1,10),&
...
40     end do
       ...
       do iz2=1,10
       write(1,12347,rec=iz2)(kr(iz,iz2),iz=1,klim+300)
       end do
12347  format(10000i7)       
       stop
