...
!      checks square root modp       
       ...
       dimension normar(100),kans(200),kpr2(2000),ipr(65000)
       dimension ivee(6,500)
...
!      start of check square root procedure 
       ...
       do i=1,idd
       print *,'square',(kdoub3(i,jk),jk=1,6)
       end do
...
5130   icdh(2)=ilen       
       ...
       call mpgcd
       print *,'ipd',ipd,'veel',ivee(1,2),'algno',kbper(1,2)
