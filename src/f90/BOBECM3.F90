...
!     uses polynomials in continuation phase 
      ...
      dimension ixdf(200,30,50),iydf(200,30,50)
      dimension kdoub2(201,300)
      dimension ixdf2(200,30,50),iydf2(200,30,50),iqarr(300),ie(300)
      iaa=1
      ...
      iprdl=799999
      kkmx=0
      open(unit=1,file='polynom',access='direct',form=&
      'formatted',recl=1200,status='old')
      
      
      
      
      open(unit=2,file='ecmpows',access='direct',form=&
      'formatted',recl=12000,status='old')
...
801   iq1=lten
      ...
      ibbsw2=1
      goto 131
802   write (2,4992,rec=ibr1)((ix2(i,jf),jf=1,50),i=1,30),&
      ((iy2(j,jk),jk=1,50),j=1,30)
      do i=1,30
      do jf=1,ix2(i,2)+2
      ix1(i,jf)=ix2(i,jf)
      end do
      ...
      if (ibr1.eq.200)goto 803
      ibr1=ibr1+1
      goto 801
      
!     setting up ibig      
803   ibig=1
809   irs=(ibig*(405-ibig))/2 -201
      print *,'ibig',ibig
      ibr2=202-ibig
      irv=irs
      do i3=1,ibr2
...
824   if (ibig2.eq.ibr2)goto 808   
      ...
      goto 807
808   if (ibig.eq.201)goto 900      
      ibig=ibig+1
      goto 809
810   ivvr=ibig2-1
      read (2,4992,rec=ivvr)((ix2(i,jf),jf=1,50),i=1,30),&
      ((iy2(j,jk),jk=1,50),j=1,30)
