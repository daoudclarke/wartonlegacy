      ...
      program wobmpbk2 
!     second of two stages of MPQS large prime variant procedures   
...
81111 format (10000i3)
      read (8,81111,rec=1)(nbbp(jf),jf=1,10000)
...
93000 read (4,*,end=93111)irecnn
      read (4,*)irecnn
      goto 93000

      
93111 lglm=log10(rel) 
      goto 512
      key =1
      print *,'number?'
      read *,istring
...
!      write(3,5,rec=2)(kr(jf,1),jf=1,30000)
!      write(3,5,rec=3)(kr(jf,2),jf=1,30000)
...
!     if (litd(3).gt.120)goto 1500
      itemp=litd(3)*10000+litd(4)
      do i=20001,23026
      if (itemp.eq.ipr(i))goto 14902
      end do
      goto 1500
