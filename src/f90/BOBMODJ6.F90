...
!     smaller sieving interval
     ...
     common kpf(120),kqf(120),krf(120),iroota(2,120),khsq(120)
      ...
      dimension memfil3(4,60),memfil4(15,100)
      kpf(1)=0
      kpf(2)=1
      kpf(3)=2
      kqf(1)=0
...
!      print *,'dis 1',(irecarr(jk),jk=1,limt)
      goto 200
198   a=a
...
400   close (unit=2)      
      close (unit=3)
      print *,'dis4s',(memfil4(jf,2),jf=1,icd4)
...
! 620    print *,'ok3'
     ...
     common ntest(100),nfact1(100),kdcorn(200),lcorn(200),mmbig(100),jgg(100)
     common kpf(120),kqf(120),krf(120),iroota(2,120),khsq(120)
!       print *,'came in ok khsq=',(khsq(jf),jf=1,khsq(2)+2)
...
!     smaller sieving interval
     ...
     common kpf(120),kqf(120),krf(120),iroota(2,120),khsq(120)
      ...
      dimension itempr(120),kicr(120),ians2(2,120)
...
103   a=a
      if (iroota(2,2).eq.0)goto 314
      print *,'invcom',(invcom(jf),jf=1,invcom(2)+2)
      print *,'iroota',(iroota(1,jf),jf=1,iroota(1,2)+2)
      print *,'irootac',(iroota(2,jf),jf=1,iroota(2,2)+2)
      ...
      do jf=1,isqurar(1,1,2)+2
      marr(jf)=isqurar(1,1,jf)
      end do
      do jf=1,iroota(2,2)+2
      mbarr(jf)=iroota(2,jf)
      end do
      call menmul
      do jf=1,mcarr(2)+2
      karr(jf)=mcarr(jf)
      ...
      call mpadd(0)
      do jf=1,kcarr(2)+2
      iroota(1,jf)=kcarr(jf)
      end do
      goto 314
105   do jf=1,mcarr(2)+2 
      iroota(1,jf)=mcarr(jf)
      end do
