...
!      read (2)kr
      ...
      do iz2=1,9
      print *,'iz2',iz2
      read (1,12347,rec=iz2)(kr(iz,iz2),iz=1,6000)
      end do
!      print *,((kr(iz,iz2),iz=1,4500),iz2=1,2)
      ...
      do iz=1,6000
!      do iz=1,4500
      if (kr(iz,1).eq.999999)goto 12378
      icc=icc+1
!      print *,'iz',iz,'icc',icc
12378 end do      
      print *,'icc',icc
...
12349 do i=2,6000
      ...
      call sieve(1,1,irecnn,kkmx,7)
      do jf=1,ijfak(1)+2
      ifak(jf)=ijfak(jf)
      ifakn(jf)=ijfakn(jf)
      end do
      
      call sieve(1,1,irecnn,kkmx,8)
      do jf=1,ijfak(1)+2
      jfak(jf)=ijfak(jf)
      jfakn(jf)=ijfakn(jf)
      end do
...
10    norma(1)=0      
      norma(2)=1
      norma(3)=kib
11    call sieve(0,kib,irecnn,kkmx,9)
...
604   markm=markb
      markbn=ipr(iz)-markb
6041  if ((markb.gt.40000).and.(markbn.gt.40000))goto 605
...
6051  if ((markl.lt.1).and.(markln.lt.1))goto 615
      if ((markl.lt.1).or.(markl.gt.40000))goto 616
      if (kndx(markl*2-1).ne.1)goto 616
      krecarr(markl*2-1)=krecarr(markl*2-1)-lgpr(iz)
616   if ((markln.gt.40000).or.(markln.lt.1))goto 6162
...
22     if (kr(iab,1).eq.999999)goto 1306
1307  a=a
      iarp(1)=int(iprx1/10000)
      iarp(2)=iprx1-iarp(1)*10000
...
15    a=a
      ...
      subroutine fscomp(kib,vlgls,kjk)
      common karr(50),kbarr(50),kcarr(200),ipqt(50),irrr(50)
      common mnum(50)
      common ia5(5),ia4(5),ia3(5),ia2(5),ia1(5),ia0(5),m1(5),m2(5)
      common ipr(65000),norma(20),leadc(20),ijfak(20),ijfakn(20)
...
60    do i=1,5
      ...
      call sieve(1,kib,irecnn,kkmax,1)
