...
!     program for creating polynomials for bobecm & bobecm2 
      ...
      open(unit=1,file='polypow2',access='direct',form=&
      'formatted',recl=560,status='old')
      open(unit=2,file='polynom2',access='direct',form=&
...
1     call doubmul2(idegm,idegn)
      ...
      icz=icz+1
      if (icz.lt.19)goto 1
      print *,'lengths',(kdoub3(jf,2),jf=1,21)
...
113   end do
      ...
      print *,'poly',(kdoub3(i,jf),jf=1,kdoub3(i,2)+2),'nrec',nrec
      nrec=nrec+1
      end do
      do i=1,21
      do j=1,500
