...
1004  format (5i5,3000i5)       
       read (1,1004,rec=1)ired,kmx1,kmx2,izzy2,izzy3,&
       (kpr(jf),jf=1,kkll)
       close (unit=1)
       print *,'ired',ired
