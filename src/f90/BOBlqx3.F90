...
!      computation of kernel of matrix uses fastest procedure       
      ...
      common marr(200),mbarr(200),mcarr(200),mdarr(200)
       ...
       dimension ibase(50),jbase(50),itarg(50),jtarg(50),ipdf(10,12)
       dimension ipdff(10),jpdff(10),ivecno(10),ia1(20),ia0(20)
...
1006   format (60i4,10(12i4),10i2,10i2,10i2)       
       read (9,1006,rec=1)(n(jf),jf=1,60),((ipdf(i,jf),jf=1,12),&
       i=1,10),(ipdff(jf),jf=1,10),(jpdff(jf),jf=1,10),(ivecno(jf),jf=1,10)
...
6      format(40i4,3i8,4(20i4),2i5)       
       open(unit=1,file='gausf4',access='direct',form=&
...
!       print *,'ic',(ic(jf),jf=1,nn)
      ivecno(nfac)=ir
       write (9,1006,rec=1)(n(jf),jf=1,60),((ipdf(i,jf),jf=1,12),&
       i=1,10),(ipdff(jf),jf=1,10),(jpdff(jf),jf=1,10),(ivecno(jf),jf=1,10)
       print *,'n',(n(jf),jf=1,n(2)+2)
       close(unit=1)
       close(unit=2)
