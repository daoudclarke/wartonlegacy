...
!       nar(1)=0
       nar(1)=1
       write(1,1,rec=i)kkb,ihitn,(littr(jf),jf=1,20),(nar(jk),jk=1,nn-1)
       print *,'i',i
       end do
60     a=a
!       nzz=kkll+100
...
!      write(7,6,rec=1)irecnn,kkll,nzz
      ...
      nzz2=4*nzz
       ...
       read (1,1,rec=30)kkb,ihitn,(littr(jf),jf=1,20),(nar(jk),jk=1,kkll)
!       print *,kkb,(nar(jf),jf=1,300),'ihitn',ihitn
       print *,'littr',(littr(jf),jf=1,20)
      print *,'nar',(nar(jf),jf=1,kkll),'nar301',nar(301),'nar302',&
      nar(302)
